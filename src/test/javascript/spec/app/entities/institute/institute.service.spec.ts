...
describe('Service Tests', () => {
  describe('Institute Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Institute('ID', 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Institute', async () => {
      ...
      it('should update a Institute', async () => {
        const returnedFromService = Object.assign(
          {
            name: 'BBBBBB',
            type: 'BBBBBB'
      ...
      it('should return a list of Institute', async () => {
        const returnedFromService = Object.assign(
          {
            name: 'BBBBBB',
            type: 'BBBBBB'
      ...
      it('should delete a Institute', async () => {
