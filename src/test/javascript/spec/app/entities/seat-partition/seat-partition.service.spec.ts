...
describe('Service Tests', () => {
  describe('SeatPartition Service', () => {
    let injector: TestBed;
    let service: SeatPartitionService;
    let httpMock: HttpTestingController;
    let elemDefault: ISeatPartition;
    let expectedResult;
    beforeEach(() => {
      ...
      expectedResult = {};
      injector = getTestBed();
      service = injector.get(SeatPartitionService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new SeatPartition('ID', 'AAAAAAA', 0, 0, 0);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a SeatPartition', async () => {
      ...
      it('should update a SeatPartition', async () => {
        const returnedFromService = Object.assign(
          {
            district: 'BBBBBB',
            total: 1,
      ...
      it('should return a list of SeatPartition', async () => {
        const returnedFromService = Object.assign(
          {
            district: 'BBBBBB',
            total: 1,
      ...
      it('should delete a SeatPartition', async () => {
