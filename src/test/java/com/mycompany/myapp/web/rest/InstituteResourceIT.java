...
public class InstituteResourceIT extends AbstractCassandraTest {
    ...
    public void setup() {
        ...
        final InstituteResource instituteResource = new InstituteResource(instituteService);
    ...
    public void dtoEqualsVerifier() throws Exception {
        ...
        instituteDTO1.setId(UUID.randomUUID());
        ...
        instituteDTO2.setId(UUID.randomUUID());
        assertThat(instituteDTO1).isNotEqualTo(instituteDTO2);
